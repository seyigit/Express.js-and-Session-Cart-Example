...
app.get("/", (req, res) => {
  ...
  res.status(200).json({
    products: [
      ...
      { id: 2, title: "Sele Zeytin", price: 20 },
      { id: 3, title: "Petek Balı", price: 40 },
      { id: 4, title: "Vişne Reçeli", price: 60 },
      { id: 5, title: "Danet Kangal Sucuk", price: 20 },
      { id: 6, title: "Kaymak", price: 10 },
      { id: 7, title: "Zeytin Ezmesi", price: 50 },
      { id: 8, title: "Kaşar", price: 30 }
    ],
    cart : {
      items : cart,
